...
/// 录播黑名单 父分区
/// </summary>
public string BlacklistRecordingParentArea { get => this.GetPropertyValue<string>(); set => this.SetPropertyValue(value); }
public bool HasBlacklistRecordingParentArea { get => this.GetPropertyHasValue(nameof(this.BlacklistRecordingParentArea)); set => this.SetPropertyHasValue<string>(value, nameof(this.BlacklistRecordingParentArea)); }
[JsonProperty(nameof(BlacklistRecordingParentArea)), EditorBrowsable(EditorBrowsableState.Never)]
public Optional<string> OptionalBlacklistRecordingParentArea { get => this.GetPropertyValueOptional<string>(nameof(this.BlacklistRecordingParentArea)); set => this.SetPropertyValueOptional(value, nameof(this.BlacklistRecordingParentArea)); }
...
public string BlacklistRecordingTitle => null;

public string BlacklistRecordingParentArea => null;

public string BlacklistRecordingChildArea => null;
