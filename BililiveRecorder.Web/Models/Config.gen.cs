...
namespace BililiveRecorder.Web.Models
{
    public class SetRoomConfig
    {
        ...
        public Optional<bool>? OptionalSaveRawDanmaku { get; set; }
        ...
        public void ApplyTo(RoomConfig config)
        {
            ...
            if (this.OptionalSaveRawDanmaku.HasValue) config.OptionalSaveRawDanmaku = this.OptionalSaveRawDanmaku.Value;
...
namespace BililiveRecorder.Web.Models.Graphql
{
    internal class RoomConfigType : ObjectGraphType<RoomConfig>
    {
        public RoomConfigType()
        {
            ...
            this.Field(x => x.OptionalSaveRawDanmaku, type: typeof(HierarchicalOptionalType<bool>));
    ...
    internal class SetRoomConfigType : InputObjectGraphType<SetRoomConfig>
    {
        public SetRoomConfigType()
        {
            ...
            this.Field(x => x.OptionalSaveRawDanmaku, nullable: true, type: typeof(HierarchicalOptionalInputType<bool>));
